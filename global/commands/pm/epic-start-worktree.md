...
Follow `/references/git/worktree-operations.md`:
...
Task:
  ...
  prompt: |
    ...
    6. Check test manifest at .claude/epics/$ARGUMENTS/test-manifest.md
...
When implementation is complete:
  1. Review code:  /pm:epic-review $ARGUMENTS
  2. Merge via PR: /pm:epic-merge $ARGUMENTS
"
```
...
- Follow `/references/git/worktree-operations.md` for git operations
- Follow `/references/workflow/agent-coordination.md` for parallel work
