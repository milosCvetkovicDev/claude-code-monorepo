...
Before closing, use `agent-skills:code-review-and-quality` for self-review of the completed work. This replaces `superpowers:requesting-code-review` for issue-level review.